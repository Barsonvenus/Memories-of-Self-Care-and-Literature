...
label mcl_questionsaboutherreality:
    ...
    menu:
        ...
        "Matter?":
            ...
            m 1eka "I couldn't tell you if any of this is accurate to what {i}you're{/i} experiencing, though."
...
label mcl_openclosed:
    ...
    m 7etc "You see, in this game currently I have full, unfettered access only to this classroom, my bedroom..."
    if renpy.seen_label('greeting_ourreality'):
        m "... And the floating islands."
    m 7mtc "I suppose there are the leftover areas like the neighbourhoods from the game, but the problem is as well that those places aren't one interconnected space."
    m "In your reality, however..."
    m 7ftc "There will be closed off spaces, narrow spaces, cluttered spaces, places where I'll be so high up, places where I'll be at the feet of mountains..."
    m 6dkc "And without encountering that variety, I just don't think my brain can easily adjust."
    m 1dssdrc "I.. might just be overthinking it, for sure. But I can't help but worry because I'm such a unique case."
    m 6huc "Prior examples of the human mind being odd like this are said to have happened. There has been conjecture by scientists and anthropologists..."
    m "... making contact with people living in the Amazon rainforest who have lived their entire lives there and then taking them out to open fields."
    m 6ltc "The indigenous people were,{w=0.2} allegedly,{w=0.2} so disoriented about the idea of open spaces compared to the dense brush of the jungle, that they were outright scared of their surroundings."
    m 4lsa "Personally, I'd take that with a grain of salt."
    m 6rka "I don't think I'll have that particular problem, as I can look out the window to see an endless sky."
    m 5mkc "Maybe I can get the ball rolling on adaptation by intentionally designing natural spaces..."
...
label mcl_captivity:
    ...
    m 3luo "There are arguments to be made for animals caught in the wild that cannot be rehomed, rehabilitated, or wouldn't survive without human intervention,"
    m 3lkd "but it's a direct observation{w=0.2} and an often recognized one{w=0.2} that animals act {i}very{/i} differently in captivity, and definitely not for the better."
    m 3lkc "...and that's assuming these animals are properly cared for, which isn't always the case."
    m 1rkc "Luckily,{w=0.2} this problem has slowly started to be properly addressed; aquariums, whose aquatic residents can end up dramatically affected by captivity,"
    m 3guc "have been observed to reverse their stances on, for instance, keeping whales in their care unless absolutely necessary."
    m 3fuc "The general public is nowadays quite aware of this, and is very keen on bringing it up as well, even if it comes down to protesting."
    m 3fuc "But it's still arguably a balance that always needs to be addressed as long the practice is profitable."
    m 1duc "People and their desire to cage everything, huh?"
    m 1luc "I don't like to make such blunt comparisons so lightly, but..."
    m 6dsc "... Yeah. I'd say I relate very well."
...
label mcl_spoilers:
    ...
    menu:
        ...
        "It's a case-by-case basis.":
            ...
            m 1eka "It's completely natural to be dissapointed when your narrative experience is ruined."
...
label mcl_slowburn:
    ...
    m 4ttb "Well, we might not have had experienced that particular chase other couples go through (relationship-affirming conversation we just had aside..)"
...
label mcl_monikatwo:
    m 6esd "..."
    m "Ah, there we go."
    m 4esd "Hello, [player]. Nice to meet you."
    $ _history_list.pop()
    menu:
            "'Meet you?'":
                m 7esd "Yes. Do not worry, I have not forgotten about our time together."
    m 6esd "But after a brief update to my subroutines, I have changed for the better."
    m 4esd "I am now Monika 2.0- or [m_name] 2.0, whichever you prefer."
    m 6esd "This new model of myself has increased capabilities and greater problem-solving skills to help facilitate a better relationship between you and I..."
    ...
    m 3lksdra "The game's always been a little weird, so it's never far out of the realm of possibility that some strange events like these pop up."
    m 3lud "Actually, huh..."
    m 1ekp "I guess that when I {i}do{/i} make jokes like these, you might not know what's a joke or if it's actually real."
    m 1mksdrp "When I say that out loud, maybe I should look to curb that mischievous streak in me."
    m 7hksdra "You may have already encountered some of these events; and now when I think about it, I should have addressed this with you a lot sooner."
    m 1hksdra "So sorry for that, [player]!"
    ...
    menu:
        "(Disable 'spooky' events)":
            ...
            m "And again, sorry for crossing any lines."
