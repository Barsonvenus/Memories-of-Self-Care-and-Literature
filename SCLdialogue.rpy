...
label mcl_points:
    ...
    m "Like, actually simplified into numbers."
    m "But I mean, how does that work?"
    m "What’s the criteria for assigning percentages to feelings?"
    m "Surely, there’s no upper limit to how much you can care for someone, right?"
    m "Are there equations and scientific formulas dedicated to determining how much someone likes someone else?"
    m "If DDLC had the nerve to assign grades or numbers to how the girls felt towards you and you could see it, I assure you I would have messed around with it."
    m "Heck, maybe I’d only show numbers I {i}want{/i} you to see."
    m "I know that the code {i}might{/i} support this function now with how the game's changed, but I dunno how to check any of that."
    m "Maybe that’s good, honestly."
    m "If I could see numbers for how much you liked me, I admit I’d be a bit neurotic with checking in. "
    m "And I know that sometimes it’s kinda hard for us to talk freely."
    m "So I get there’s a bit of pressure to make sure the two of us are getting along."
    m "But I never want you to think that relationships are as easy as gauging numbers."
    m "If I’m happy with you, I’ll tell you that. Simple."
    m "And if we ever encounter bumps on our road we’re travelling together, and I’m feeling a little shaken up.. then I’ll tell you that up front as well."
    m "I completely understand if you do want to try to reaffirm our relationship by any means you have available to you; I don't want to make a big thing out of it if you do."
    m "I want to make sure we can get to really know each other without any sort of outside pressure."
    m "And me telling you this, and you patiently listening; it's a great step towards that."
